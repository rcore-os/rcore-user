...
struct elfhdr {
    ...
    uintptr_t e_entry;    // entry point if executable
    uintptr_t e_phoff;    // file position of program header or 0
    uintptr_t e_shoff;    // file position of section header or 0
